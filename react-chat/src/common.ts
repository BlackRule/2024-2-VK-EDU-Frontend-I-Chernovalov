...
export type Message = { files: API_MessageCommon['files'],id:string, isMine?:boolean, name: string, text: string, time: string }
...
export function messageAdapter(message: API_Message): Message {
  return {
    files: message.files,
    id: message.id,
